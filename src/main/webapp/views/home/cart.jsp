...
<body>
	...
	<section class="page-heading">
		<div class="content">
			...
			<span> <i class="fas fa-home"></i> <a href="/home/index">Trang
					chủ</a> <i class="fas fa-angle-right"></i> 
					<a href="/home/cart">Giỏ
					hàng</a> <i class="fas fa-angle-right"></i>
			</span>
		</div>
	</section>
	<!-- ====   Cart    ==== -->
	...
	<section class="cart-page">
		...
		<div class="cart-page-content">
			<c:forEach var="item" items="${cart.items}">
				<form action="/cart/update/${item.id}" method="post">
					...
					<div class="row">
						<div class="cart-product">
							<span> <img src="/images/${ item.image }" alt="">
								<p> ${item.name}</p>
							</span>
						</div>
						<div class="cart-price">
						...
						<div class="cart-quantity">
							<input name="qty" value="${item.qty}" onblur="this.form.submit()"
								style="width: 70px;" type="number" min="0" max="10">
						</div>
						<div class="cart-total">
							<p>
								<fmt:formatNumber type="number" value="${ item.price*item.qty }" />
								VND
							</p>
						</div>
						<div class="cart-delete">
							<span><a href="/cart/remove/${item.id}">Remove</a></span>
						</div>
					</div>
				</form>
			</c:forEach>
		...
		<div class="cart-footer">
			<a class="btn btn-secondary" href="/cart/clear">Xoá</a>
			<h3>
				Tổng thanh toán: <span><fmt:formatNumber type="number"
						value="${amount}" /> VNĐ</span> </span>
			</h3>
			<a class="btn btn-primary" href="/home/order">Đặt hàng</a>
		</div>
	</section>
	<!-- --------xx--------- -->
