			...
			<main>
				<div id="accountList" class="recent-orders" style="display: block; margin-bottom: 30px">
					<div id="accountMana" style="display: block; margin-bottom: 10%">
						...
						<h6 class="alert mt-4 text-center">${error}</h6>
						<form:form action="/admin/account" modelAttribute="us" method="POST">
							...
							<div class="buttons-container" style="float: right; margin-right: 5%; margin-top: 20px;">
								...
								<button type="submit" class="button-arounder" formaction="/admin/account/update">Update</button>
						...
						<tbody>
							<c:forEach var="a" items="${accounts}">
								<tr>
									...
									<td class="primary"><a href="/admin/account/edit/${a.id}"><span class="material-symbols-outlined">edit</span></a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
				...
				<%-- <div id="productList" class="recent-orders" style="display: none; margin-bottom: 30px">
					<div id="productMana" style="display: none; margin-bottom: 10%">
						...
						<form action="" method="post">
							...
							<div class="form__group">
							  <input type="text" class="form__input" name="id" placeholder="ID" />
							</div>
							<div class="form__group">
							  <input type="text" class="form__input" name="name" placeholder="Name"/>
							</div>
							<div class="form__group">
							  <input type="text" class="form__input" name="img" placeholder="images" />
							</div>
							<div class="form__group">
							...
							<div class="buttons-container" style="float: right; margin-right: 5%; margin-top: 20px;">
								<button  type="submit" class="button-arounder">Create</button>
